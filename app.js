...
var ProGrad_1 = "Keerthana";
// 1.2 Print `"The driver's name is XXXX"`.
console.log(ProGrad_1);
// 1.3 Create a variable `ProGrad-2` with the navigator's name.
var ProGrad_2 = "Prasanth";
...
// - If it contains vowels, print the number of name, 
//and also print the vowel letters along with the vowel characters. or
// - print no vowels
